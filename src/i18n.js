...
const STR = {
  en: {
    ...
    scanMoreAddrLabel: 'Additional addresses to scan',
    scanMoreAddrBtn: 'Scan {n} more',
    scanMoreDone: 'Scanned {n} addresses',

    silentPayments: 'Silent Payments',
    spSettingsDesc: 'Your reusable silent payment address. Others can send to this address without ever interacting with you — payments arrive as one-time taproot outputs that only you can detect and spend.',
    spScanBtn: 'Scan blocks for silent payments',
    spScanning: 'Scanning blocks…',
    spScanFromHeight: 'Scan from block height',
    spScanFound: 'Found {n} silent payment{plural}',
    spScanNone: 'No silent payments found in scanned blocks.',
    spScanError: 'Silent payment scan failed.',
    spDerivedOutput: 'Derived from the static address above — a unique one-time output',
    spDetectedCount: '{n} silent payment{plural} detected. Scan more blocks to find additional payments.',
    spScanMoment: 'a moment…',
    spScanSeconds: '{n}s remaining',
    spReceiveDesc: 'Share this address to receive silent payments. Unlike normal addresses, it never changes — you publish it once and senders derive a unique output each time.',
    spReceiveDetected: '{n} silent payment{plural} received (detected via block scan)',
    addressMode: 'Address type',
    addrModeNormal: 'Normal',
    addrModeSP: 'Silent Payment',
    unusedTag: 'unused',
    scanning: 'Scanning…',
    ...
    rescanPending: 'Rescan pending ({n})',

    scanSeedQr: 'Scan seed QR',
    tabSign: 'Sign',
    signPsbt: 'Sign external PSBT',
    psbtDesc: 'Import a partially-signed Bitcoin transaction (PSBT) from another device, sign it with this wallet, and export the signed result.',
    psbtLabel: 'PSBT',
    psbtPlaceholder: 'Paste PSBT hex or base64',
    psbtScanBtn: 'Scan PSBT QR',
    psbtSignBtn: 'Sign transaction',
    psbtSigning: 'Signing…',
    psbtNoKeys: 'No inputs in this PSBT match this wallet.',
    psbtSignError: 'Signing failed: {msg}',
    psbtInputsSigned: 'Signed {n} of {total} input{plural}',
    psbtFinalized: 'Transaction finalized — ready to broadcast.',
    psbtSignedNote: 'Transaction signed. Share it to broadcast from an online device.',
    psbtShowQr: 'Show as QR',
    psbtCopyBase64: 'Copy (base64)',
    psbtCopyHex: 'Copy (hex)',
    psbtSave: 'Save file',
  },
};
