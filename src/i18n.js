...
const STR = {
  en: {
    ...
    backendEsplora: 'Explorer',
    backendElectrum: 'Electrum',
    backendElectrumDesc: 'Fetch data and get instant payments over one Electrum WebSocket. Point it at your own Fulcrum/electrs for a fully self-hosted wallet — no coinos, no REST.',
