...
const STR = {
  en: {
    ...
    importLabel: 'Recovery phrase, descriptor or key',
    importPlaceholder: 'Seed words, descriptor (wpkh…), or extended key (xpub/zpub/tpub/…)',
    ...
    scanGapLimit: 'Gap limit',
    scanGapLimitDesc: 'How many unused addresses to scan before stopping (default 20). Increase for deep wallet recovery.',
    scanFromDate: 'Scan from date',
    scanFromDateDesc: 'Only fetch transactions after this date (optional, speeds up history on old wallets).',
    retry: 'Retry',
    ...
    network: 'Network',
    networkDesc: 'Switch between mainnet, testnet, testnet4, signet, or regtest. The network must match before importing a snapshot.',
    net_mainnet: 'Mainnet',
    net_testnet: 'Testnet',
    net_testnet4: 'Testnet4',
    net_signet: 'Signet',
    net_regtest: 'Regtest',
    labels: 'Transaction labels',
    labelsDesc: 'Export labels as a BIP-329 JSON file, or import labels from one. Labels are also included in wallet snapshots.',
    exportLabels: '⤓ Export labels',
    importLabels: 'Import labels…',
    labelsExported: 'Labels exported',
    importedNLabels: 'Imported {n} label(s)',
    newAddress: 'New address',
    txLabel: 'Label',
    txLabelPlaceholder: 'e.g. coffee with Alice',
  },
};
