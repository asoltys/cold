...
const STR = {
  en: {
    ...
    giftWelcomeBody: 'This wallet is yours now. Anyone with its recovery phrase controls the coins, so back it up before you do anything else.',
    giftBackup: 'Back up this wallet',
    giftSkip: 'Skip for now',
    giftBackedUp: 'I’ve written it down',
    giftLink: 'Gift this wallet',
    giftLinkDesc: 'Create a link that opens this wallet, with its funds, for onboarding someone fast.',
    giftLinkWarn: '⚠ Anyone who opens this link controls all the funds in this wallet. Only share it to give the wallet away, and keep the amount small.',
