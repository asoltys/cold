...
const STR = {
  en: {
    ...
    giftAmountInvalid: 'Enter a valid amount.',
    giftAnother: 'Create another',
    giftReserved: '{n} coin set aside for unclaimed gifts',
    giftRevoke: 'Revoke',
    giftRevokeConfirm: 'Revoke this gift? This spends the coin back into your wallet and stops the link from working.',
