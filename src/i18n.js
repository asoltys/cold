...
const STR = {
  en: {
    ...
    backendElectrumDesc: 'Data and instant payments over one Electrum WebSocket. Point it at your own Fulcrum/electrs for a fully self-hosted wallet — no coinos, no REST.',
